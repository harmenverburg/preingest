...
<xsl:stylesheet
    ...
    <xsl:param name="status-api-basepath" as="xs:string" required="yes"/>
    ...
    <xsl:variable name="nha:status-uri-prefix" as="xs:string" select="$preingest-scheme-host-port || $status-api-basepath"/>
    <xsl:variable name="nha:output-uri-prefix" as="xs:string" select="$preingest-scheme-host-port || $output-api-basepath"/>
