...
{
    public class SipZipValidationCommand : AbstractPreingestCommand
    {
        public override ValidationActionType ActionTypeName => ValidationActionType.SipZipMetadataValidationHandler;

        public SipZipValidationCommand(ILogger<PreingestEventHubHandler> logger, Uri webapi) : base(logger, webapi) { }
